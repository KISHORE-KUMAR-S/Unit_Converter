...
//    )
    ...
    Column (
        ...
        Text(text = "Unit Converter", modifier = Modifier.padding(10.dp), style = MaterialTheme.typography.headlineLarge)
...
//            Button(onClick = { Toast.makeText(context, "Thanks for clicking!", Toast.LENGTH_SHORT).show() }) {
//                Text(text = "Click Me!")
//            }
            //Input Box
            Box {
                ...
                DropdownMenu(expanded = inputExpanded, onDismissRequest = { inputExpanded = false }) {
                    ...
                    DropdownMenuItem(text = { Text(text = "Feet") }, onClick = {
                        inputExpanded = false
                        inputUnit = "Feet"
                        inputConversionFactor.doubleValue = 0.348
                        convertUnits()
                    })
        ...
        Spacer(modifier = Modifier.height(16.dp))
        Text(text = "Result \n $outputValue", style = MaterialTheme.typography.headlineSmall)
    }
}
